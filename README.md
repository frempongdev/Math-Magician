...
<div align="center">
  ...
  <img src="https://ih1.redbubble.net/image.2309281795.3774/st,small,507x507-pad,600x600,f8f8f8.jpg" alt="logo" width="120"  height="auto" />
  <br/>
   <br/>

  <h2><b>Math Magician</b></h3>
...
**Math-Magician** is a single page application project that helps in Mathematical calculation and also displays random Mathematical Quotes. 
...
- **This project helps users do basic Math calculations**
- **This project displays the results of the calculations dynamically on the DOM**
- **This project makes use of an API fetch**
...
```sh
 https://github.com/frempongdev/Math-Magician.git
```
<br>
...
```sh
  cd your-folder
  git clone https://github.com/frempongdev/Math-Magician.git 
```
